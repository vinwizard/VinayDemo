...
import type {
  Answer, AttributeScore, Demand, DriftReport, Probe, QueryEvaluation, Run, SearchTry, WinBackAction, RunSummary, VisibilitySet, Zone,
} from "./api";
    ...
    <article className="report">
      ...
      {d ? (
        <div className="report-panel" role="tabpanel" id={`${uid}-panel-${tab}`} aria-labelledby={`${uid}-tab-${tab}`}
          ...
          {tab === "why" && <><WhatItSearched run={run} /><WhyAIMisses run={run} /></>}
