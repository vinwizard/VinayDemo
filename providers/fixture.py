...
class FixtureProvider:
    ...
    def positioning(self, run: Run):
        """The authored positioning map: hand-placed points built from the fixture's own sentences,
        labelled sample wherever it appears. Nothing is embedded."""
